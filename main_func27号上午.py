...
if __name__ == "__main__":
    ...
    im_path = os.path.join(wd,'frames_00303.jpg')
    ...
    #image_path='/mnt/disk1/gyl/new_retail_0226/Goods_db/query/0016.jpg'
    ...
    cv2.imwrite('/mnt/disk1/gyl/result_reco.jpg',image)
